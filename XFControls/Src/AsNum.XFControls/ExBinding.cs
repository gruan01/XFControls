...
namespace AsNum.XFControls {
    public sealed class ExBinding : BindingBase {
        ...
        public ExBinding(string path, BindingMode mode = BindingMode.Default, IValueConverter converter = null, object converterParameter = null, string stringFormat = null, object source = null) {
            if (path == null)
        ...
        public static ExBinding Create<TSource>(Expression<Func<TSource, object>> propertyGetter, BindingMode mode = BindingMode.Default, IValueConverter converter = null, object converterParameter = null,
                                              string stringFormat = null) {
            if (propertyGetter == null)
                throw new ArgumentNullException("propertyGetter");

            string path = GetBindingPath(propertyGetter);
            return new ExBinding(path, mode, converter, converterParameter, stringFormat);
        }
        ...
        internal override BindingBase Clone() {
            return new ExBinding(Path, Mode) { Converter = Converter, ConverterParameter = ConverterParameter, StringFormat = StringFormat, Source = Source };
        }
